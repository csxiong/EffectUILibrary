package me.csxiong.uiux.ui.video.videocache.file;

import me.csxiong.uiux.ui.video.videocache.ThreadUtils;
...
public abstract class LruDiskUsage implements DiskUsage {
    ...
    public void touch(File file) throws IOException {
        threadPoolExecutor.submit(new TouchCallable(file));
    }
