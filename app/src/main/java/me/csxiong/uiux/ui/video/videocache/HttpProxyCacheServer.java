...
import me.csxiong.uiux.ui.video.videocache.file.DiskUsage;
import me.csxiong.uiux.ui.video.videocache.file.FileNameGenerator;
import me.csxiong.uiux.ui.video.videocache.file.Md5FileNameGenerator;
import me.csxiong.uiux.ui.video.videocache.file.TotalCountLruDiskUsage;
import me.csxiong.uiux.ui.video.videocache.file.TotalSizeLruDiskUsage;
import me.csxiong.uiux.ui.video.videocache.headers.EmptyHeadersInjector;
import me.csxiong.uiux.ui.video.videocache.headers.HeaderInjector;
import me.csxiong.uiux.ui.video.videocache.sourcestorage.SourceInfoStorage;
import me.csxiong.uiux.ui.video.videocache.sourcestorage.SourceInfoStorageFactory;
...
public class HttpProxyCacheServer {
    ...
    private final ThreadPoolExecutor socketProcessor = ThreadUtils.Companion.newFixedThreadPool(8);
    private final Map<String, HttpProxyCacheServerClients> clientsMap = new ConcurrentHashMap<>();
    private final ServerSocket serverSocket;
    private final int port;
    private final ThreadPoolExecutor threadPoolExecutor = ThreadUtils.Companion.createSingleThreadExecutors();
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            threadPoolExecutor.execute(new WaitRequestsRunnable(startSignal));
