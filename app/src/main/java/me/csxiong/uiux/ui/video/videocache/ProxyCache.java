...
class ProxyCache {
    ...
    private synchronized void readSourceAsync() throws ProxyCacheException {
        boolean readingInProgress = threadPoolExecutor != null && !threadPoolExecutor.isTerminated();
        if (!stopped && !cache.isCompleted() && !readingInProgress) {
            threadPoolExecutor = ThreadUtils.Companion.createSingleThreadExecutors();
            threadPoolExecutor.execute(new SourceReaderRunnable());
        }
    }
